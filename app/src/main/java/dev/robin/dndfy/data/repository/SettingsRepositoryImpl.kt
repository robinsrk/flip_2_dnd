package dev.robin.dndfy.data.repository
...
import dev.robin.dndfy.presentation.settings.Sound
import dev.robin.dndfy.presentation.settings.VibrationPattern
...
private const val PREFS_NAME = "dndfy_settings"
...
class SettingsRepositoryImpl @Inject constructor(
	...
	private fun restartFlipDetectorService() {
		try {
			val serviceIntent = Intent(appContext, DNDfyDetectorService::class.java)
			...
			Log.d(TAG, "DNDfyDetectorService restarted successfully")
		} catch (e: Exception) {
			Log.e(TAG, "Error restarting DNDfyDetectorService: ${e.localizedMessage}", e)
		}
	}
